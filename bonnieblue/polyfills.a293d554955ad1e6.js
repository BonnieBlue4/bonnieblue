...
<html lang="en" data-beasties-container>
    <head>
        ...
        <meta name="twitter:site" content="@fansly">

        <title>Fansly - Start Interacting With Your Fans</title>
        <meta name="description" content="Interact with your fans today and start selling content. Sign up today and make a free account.">
        <meta name="keywords" content="fansly">

        <meta property="og:site_name" content="Fansly">
        <meta property="og:title" content="Fansly.com">
        <meta property="og:description" content="Interact with your fans today and start selling content. Sign up today and make a free account.">
        <meta property="og:image" content="https://fansly.com/assets/images/twitter-card-image.png">
...
@font-face {
  ...
  unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+0304, U+0308, U+0329, U+2000-206F, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
        ...
        <meta name="apple-mobile-web-app-title" content="Fansly">

        <link rel="apple-touch-icon" sizes="180x180" href="/assets/images/icons/apple-touch-icon.png?v=12">
        <link rel="icon" type="image/png" sizes="32x32" href="/assets/images/icons/favicon-32x32.png?v=12">
        <link rel="icon" type="image/png" sizes="16x16" href="/assets/images/icons/favicon-16x16.png?v=12">
        <link rel="manifest" href="/assets/images/icons/site.webmanifest?v=12">
        <link rel="mask-icon" href="/assets/images/icons/safari-pinned-tab.svg?v=12" color="#279eff">
        <link rel="shortcut icon" href="/assets/images/icons/favicon.ico?v=12">
        <meta name="msapplication-TileColor" content="#ffffff">
        <meta name="msapplication-config" content="/assets/images/icons/browserconfig.xml?v=12">
        ...
        <script src="/assets/js/gtagmanager.js" defer></script>
...
@font-face{
  ...
  src:url('fa-solid-900.8fff52e3ca526baf.woff2')format("woff2"),url('fa-solid-900.dedde6124f77d1aa.ttf')format("truetype")
...
</style><link rel="stylesheet" href="styles.e2b13d2ff064129b.css" crossorigin="use-credentials" media="print" onload="this.media='all'"><noscript><link rel="stylesheet" href="styles.e2b13d2ff064129b.css" crossorigin="use-credentials"></noscript></head>

    <body>
        <!-- Google Tag Manager (noscript) -->

        <noscript>
            <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WG8ZFQG" height="0" width="0" style="display:none;visibility:hidden"></iframe>
        </noscript>
        <!-- End Google Tag Manager (noscript) -->

        <app-root>
            <!--::TODO add inline javascript to apply theme class to loading spinner-->
            <div class="loading-wrapper">
                <div class="loading-content">
                    <img class="dark-theme-only" width="2856" height="798" src="/assets/images/fansly_dark_v3.webp">
                    <img class="bright-theme-only" width="2856" height="798" src="/assets/images/fansly_light_v3.webp">

                    <i class="fa-fw fal fa-spinner-third fa-spin fa-3x margin-top-2"></i>
                </div>
            </div>
        </app-root>
        ...
        <script>
            (function() {
                ...
                var checkTheme = function() {
                    ...
                    let themeMetaElement = getMeta("theme-color");

                    if (htmlElement && bodyElement && themeMetaElement) {
                        //if (htmlElement) {
                        ...
                        var availableThemes = ["bright", "dark"];
                        var currentTheme = localStorage
                            ? localStorage.getItem("theme_service_current_theme") || defaultTheme
                            : defaultTheme;

                        if (!currentTheme || currentTheme === "null" || availableThemes.indexOf(currentTheme) < 0) {
                            currentTheme = defaultTheme;
                        }

                        if (currentTheme === "bright" && htmlElement.className.indexOf("bright-theme") === -1) {
                            htmlElement.className += " bright-theme";
                        } else if (currentTheme === "dark" && htmlElement.className.indexOf("dark-theme") === -1) {
                            htmlElement.className += " dark-theme";
                        }

                        if (themeMetaElement && currentTheme === "bright") {
                            themeMetaElement.setAttribute("content", "#ffffff");
                        } else if (themeMetaElement && currentTheme === "dark") {
                            themeMetaElement.setAttribute("content", "#16161a");
                        }
                    } else {
                        setTimeout(function() {
                            checkTheme();
    ...
    <script src="runtime.77edb7fd34266674.js" type="module" crossorigin="use-credentials"></script><script src="polyfills.a293d554955ad1e6.js" type="module" crossorigin="use-credentials"></script><script src="scripts.32f933722bcf11de.js" defer crossorigin="use-credentials"></script><script src="main.8edeb980251a2408.js" type="module" crossorigin="use-credentials"></script></body>
</html>
